...
// model
import { Accessoire } from "../_models/accessoire.model"

const API_URL = environment.apiUrl + "/accessoires"
...
export class AccessoireService {
    ...
    // CREATE
    public add(accessoire: Accessoire) {
        const httpHeaders = this.httpUtils.getHTTPHeaders()
        return this.http.post(API_URL, accessoire, { headers: httpHeaders })
    }
    // READ
    public getAll() {
        const httpHeaders = this.httpUtils.getHTTPHeaders()
