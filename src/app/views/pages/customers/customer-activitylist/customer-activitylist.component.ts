...
import { CustomerService, SaleOrderService, printCustomerActivity } from "../../../../core/erp"
@Component({
  selector: 'kt-customer-activitylist',
  templateUrl: './customer-activitylist.component.html',
  styleUrls: ['./customer-activitylist.component.scss']
})
...
onSubmit() {
 ...
 /**
  ...
  prepare(): any {
    ...
    if (controls.cm_class_2.value == null || controls.cm_class_2.value == "" ) { this.class2 = "ZZZZZZZZZZZZZ" } else {this.class2 = controls.pt_part_2.value}
...
getbyall(obj:any) {
    ...
    this.saleorderService.getCustomerActivity(obj).subscribe(
