...
import { ToolService } from "../../../../core/erp"

@Component({
  selector: 'kt-list-tool',
  templateUrl: './list-tool.component.html',
  styleUrls: ['./list-tool.component.scss']
})
export class ListToolComponent implements OnInit {
  ...
  prepareGrid() {
      ...
      this.dataset = []
      this.toolService.getAllwithDetail().subscribe(
