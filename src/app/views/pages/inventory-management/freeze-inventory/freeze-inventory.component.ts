...
@Component({
  selector: 'kt-freeze-inventory',
  templateUrl: './freeze-inventory.component.html',
  styleUrls: ['./freeze-inventory.component.scss']
})
export class FreezeInventoryComponent implements OnInit {
  ...
  createPhysicalInventoryTag(obj:any) {
      ...
      this.inventoryManagementService.freezeInventory(obj).subscribe(
