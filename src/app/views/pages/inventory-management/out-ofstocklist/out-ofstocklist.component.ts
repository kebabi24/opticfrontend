...
import { InventoryManagementService, printInventoryOfSecurity } from "../../../../core/erp"
@Component({
  selector: 'kt-out-ofstocklist',
  templateUrl: './out-ofstocklist.component.html',
  styleUrls: ['./out-ofstocklist.component.scss']
})
export class OutOFStocklistComponent implements OnInit {
  tagForm: FormGroup
  hasFormErrors = false
  isExist = false
...
getReport(obj:any) {
  ...
  this.inventoryManagementService.inventoryOfSecurity(obj).subscribe(
