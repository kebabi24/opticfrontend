...
import { ProviderService, PurchaseOrderService, printProviderActivity, printProviderBalance } from "../../../../core/erp"
@Component({
  selector: 'kt-balance-generale',
  templateUrl: './balance-generale.component.html',
  styleUrls: ['./balance-generale.component.scss']
})

export class BalanceGeneraleComponent implements OnInit {
  tagForm: FormGroup
  hasFormErrors = false
  isExist = false
...
getbyall(obj:any) {
  ...
  this.purcahseorderService.getProviderBalance(obj).subscribe(
