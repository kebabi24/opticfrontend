              ...
              this.gridService.addItem(
                    {
                     ...
                     apamt: applied,
                     ard_type: "I",
                   //  ard_acct: this.provider.vd_ar_acct,
                    // ard_sub: this.provider.vd_ar_sub,
                     //ard_cc: this.provider.vd_ar_cc,
            ...
            this.gridService.addItem(
              {
               ...
               apamt: applied,
               ard_type: "U",
               //ard_acct: this.provider.vd_act_acct,
               //ard_sub: this.provider.vd_act_sub,
               //ard_cc: this.provider.vd_act_cc,
               ard_ex_rate: controls.ar_ex_rate.value,
               ard_ex_rate2: controls.ar_ex_rate2.value,
              // ard_dy_code: controls.ar_dy_code.value,
