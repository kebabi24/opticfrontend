    ...
    <form class="form-inline">
      <div class="form-group">
        <div class="input-group">
          <input class="form-control" placeholder="jj-mm-aaaa" name="dp" [(ngModel)]="model" ngbDatepicker #d="ngbDatepicker">
  ...
  <div>
    <form class="form-inline">
      <div class="form-group kt-form__group">
        <div class="input-group">
		  <input class="form-control" placeholder="jj-mm-aaaa" name="dp" [displayMonths]="displayMonths"
...
<div class="example-preview">
  ...
  <div>
    <form class="form-inline">
      <div class="form-group">
        <div class="input-group">
		  <input class="form-control" placeholder="jj-mm-aaaa" name="d22" #c2="ngModel" [(ngModel)]="model2"
...
<div class="example-preview">
  ...
  <div>
    <form class="form-inline">
      <div class="form-group">
        <div class="input-group">
		  <input class="form-control" placeholder="jj-mm-aaaa" name="dp" [(ngModel)]="fifthModel" ngbDatepicker
